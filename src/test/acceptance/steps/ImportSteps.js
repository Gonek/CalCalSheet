...
class ImportThenSteps extends Steps{
    items_imported(){
        ...
        this.test.assertEqualsArray(items[0], expected_row_1);
        this.test.assertEqualsArray(items[11], expected_row_12);
        this.test.assertEqualsArray(items[26], expected_row_27);
        this.test.assertEqualsArray(items[45], expected_row_46);
    }
    ...
    items_imported_with_merge(){
        ...
        this.test.assertEqualsArray(items[0], expected_row_1);
        this.test.assertEqualsArray(items[26], expected_row_27);
        this.test.assertEqualsArray(items[53], expected_row_54);
        this.test.assertEqualsArray(items[59], expected_row_60);
    }

    items_not_imported(){
        let items = getSpr(SPR.ITEMS).getValues('B4:AA');
        this.test.assertArrayEmpty(items);
    }
    ...
    recipes_imported(){
        ...
        this.test.assertEqualsArray(recipes, expected);
    }
    ...
    recipes_not_imported(){
        ...
        this.test.assertArrayEmpty(recipes);
    }
    ...
    meals_imported(){
        ...
        this.test.assertEqualsArray(meals, expected);
    }
    ...
    meals_not_imported(){
        ...
        this.test.assertArrayEmpty(meals);
    }
    ...
    profile_imported(){
        ...
        this.test.assertEqualsArray(profiles, expected);
    }
    ...
    settings_imported(){
        ...
        this.test.assertEqualsArray(generalSettings, [2, 2, 'Calorie Max', false, false, true, false]);
        this.test.assertEqualsArray(nutritionFields, [true, true, false, true, false, true, false, true, true]);
        this.test.assertEqualsArray(meals,           [['Morning food', 10],
                                                      ['Secound brekfast', 8],
                                                      ['Feast', 15],
                                                      ['Late lunch', 7],
                                                      ['Supper', 9],
    ...
    history_imported(){
        ...
        this.test.assertEqualsArray(history, expected);
    }

    history_not_imported(){
        let history = getSpr(SPR.HISTORY).getValues('B10:R18');
        this.test.assertArrayEmpty(history);
    }
    ...
    days_imported(){
        ...
        this.test.assertEqualsArray(daysSpr.getValues('B4:M93'), expected);
        this.test.assertEqualsArray(daysSpr.getValues('N4:N5'), expectedAdditionalInfo);
        this.test.assertEqualsArray(daysSpr.getValues('N19:N20'), expectedAdditionalInfo);
        this.test.assertEqualsArray(daysSpr.getValues('N34:N35'), expectedAdditionalInfo);
        this.test.assertEqualsArray(daysSpr.getValues('N49:N50'), expectedAdditionalInfo);
        this.test.assertEqualsArray(daysSpr.getValues('N64:N65'), expectedAdditionalInfo);
        this.test.assertEqualsArray(daysSpr.getValues('N79:N80'), expectedAdditionalInfo);
    }

    days_not_imported(){
        let days = getSpr(SPR.DAYS).getValues('B4:M');
        this.test.assertArrayEmpty(days);
    }
}