class DayServiceTest extends TestBase {
    beforeAll(){
        ...
        this.selectedDayItemsRng = mockRng(RNG.SELECTED_DAY_ITEMS);
        ...
        this.saveMealAsRng = mockRng(RNG.SAVE_MEAL_AS);
        this.saveMealFromRng = mockRng(RNG.SAVE_MEAL_FROM);
        this.saveMealFromMealIdRng = mockRng(RNG.SAVE_MEAL_FROM_MEAL_ID);
        this.copyMealToRowsRng = mockRng(RNG.COPY_MEAL_TO_ROWS);
        this.copyMealFromMealIdsRng = mockRng(RNG.COPY_MEAL_FROM_MEAL_IDS);
        this.copyMealFromRng = mockRng(RNG.COPY_MEAL_FROM);
        this.copyMealToRng = mockRng(RNG.COPY_MEAL_TO);
        ...
        this.additionalDataRng = mockRng(RNG.ADDITIONAL_DATA);
        this.meal1Rng = mockRng(RNG.MEAL1);
        this.meal3Rng = mockRng(RNG.MEAL3);
        this.meal5Rng = mockRng(RNG.MEAL5);
        this.meal1StartRng = mockRng(CBOX.MEAL_1_START);
        this.mockBox = mock(new CBox(CBOX.MEAL_1_START));
