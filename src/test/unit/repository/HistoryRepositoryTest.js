class HistoryRepositoryTest extends TestBase {
    ...
    shouldAddOrUpdateAddHistoryIfSelectedDayZero(){
        ...
        // THEN
        verify(this.historySht).appendRow(['', '01/01/2025', 2000, 2500, '=IFERROR(D10-C10)', 10, 11, 12, 13, 14, 15, 16, 17, 18, 85.5, '✔️', '❌', '✔️']).calledOnce();
    ...
    shouldAddOrUpdateUpdateHistoryIfSelectedDayNotZero(){
        ...
        this.historyRepository.addOrUpdate(history);
        // THEN
        verify(this.historySht).setAreaValue(19, 1, 1, 18, [['', '01/01/2025', 2000, 2500, '=IFERROR(D19-C19)', 10, 11, 12, 13, 14, 15, 16, 17, 18, 85.5, '✔️', '❌', '✔️']]).calledOnce();
    }
