class TestData {
  ...
  makeSheetReleaseReady(){
    ...
    daySht.setValue('A17','=texts!B393');
    daySht.setValue('A32','=texts!B394');
    daySht.setValue('A47','=texts!B395');
    ...
    newItemSht.setValue('C23','=texts!B529');
    let recipeCalcSht = getSht(SHT.RECIPE_CALCULATOR);
    recipeCalcSht.setValue('C33','=texts!B529');
    recipeCalcSht.setValue('C35','=texts!B532');
    let profileSht = getSht(SHT.PROFILE);
    profileSht.setValue('D19','=texts!B511');
    profileSht.setValue('D21','=texts!B513');
    ...
    daysSht.setValue('F5','=texts!B395');
    daysSht.setValue('H5','=texts!B396');
    daysSht.setValue('J5','=texts!B397');
    daysSht.setValue('L5','=texts!B398');    
    daysSht.setValue('Q5','=texts!B393');
    daysSht.setValue('S5','=texts!B394');
    daysSht.setValue('U5','=texts!B395');
    daysSht.setValue('W5','=texts!B396');
    daysSht.setValue('Y5','=texts!B397');
    daysSht.setValue('AA5','=texts!B398');
    let historySht = getSht(SHT.HISTORY);
    historySht.setValue('B3','=texts!B543');
    let settingsSht = getSht(SHT.SETTINGS);
    settingsSht.setValue('E7','=texts!B519');
    settingsSht.setValue('E26','=texts!B547');
    settingsSht.setValue('K5','=texts!B527');
    settingsSht.setValue('K6','=texts!B527');
    settingsSht.setValue('K7','=texts!B527');
    settingsSht.setValue('F14','=texts!B393');
    settingsSht.setValue('F15','=texts!B394');
    settingsSht.setValue('F16','=texts!B395');
    settingsSht.setValue('F17','=texts!B396');
    settingsSht.setValue('F18','=texts!B397');
    settingsSht.setValue('F19','=texts!B398');

    this.clearItems();
    var data = [  
                  ['=texts!B399',	  100,	    'g',	  1,	  576,	5.76,	49.00,0.49,	3.7,  0.04,	0.0,	0.00,	22.0,	0.22,	12.0,	0.12,	3.9,	0.04,	0,	0.00,	21.0,	0.21,	1,		0.01,	0,	0,	'Red',		5.76],
                  ['=texts!B400',	  100,	    'g',	  1,	  52,		0.52,	0.20,	0.00,	0.0,	0.00,	0.0,	0.00,	14.0,	0.14,	2.4,	0.02,	10.0,	0.10,	0,	0.00,	0.3,	0.00,	1,		0.01,	0,	0,	'Green',	0.52],
                  ['=texts!B401',	  100,	    'g',	  1,	  20,		0.20,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	3.9,	0.04,	2.1,	0.02,	1.9,	0.02,	0,	0.00,	2.2,	0.02,	2,		0.02,	0,	0,	'Green',	0.20],
                  ['=texts!B402',	  100,	    'g',	  1,	  160,	1.60,	14.70,0.15,	2.1,	0.02,	0.0,	0.00,	8.5,	0.09,	6.7,	0.07,	0.7,	0.01,	0,	0.00,	2.0,	0.02,	7,		0.07,	0,	0,	'Yellow',	1.60],
                  ['=texts!B403',	  100,	    'g',	  1,	  53,		0.53,	0.00,	0.00,	0.0,	0.00,	0.0,	0.00,	28.0,	0.28,	0.0,	0.00,	0.0,	0.00,	0,	0.00,	0.0,	0.00,	0,		0.00,	0,	0,	'Green',	0.53],
                  ['=texts!B404',	  100,	    'g',	  1,	  89,		0.89,	0.30,	0.00,	0.1,	0.00,	0.0,	0.00,	23.0,	0.23,	2.6,	0.03,	12.0,	0.12,	0,	0.00,	1.1,	0.01,	1,		0.01,	0,	0,	'Green',	0.89],
                  ['=texts!B405',	  100,	    'g',	  1,	  27,		0.27,	0.10,	0.00,	0.1,	0.00,	0.0,	0.00,	3.2,	0.03,	1.9,	0.02,	0.2,	0.00,	0,	0.00,	2.5,	0.03,	6,		0.06,	0,	0,	'Green',	0.27],
                  ['=texts!B406',	  100,	    'g',	  1,	  24,		0.24,	0.20,	0.00,	0.0,	0.00,	0.0,	0.00,	4.3,	0.04,	1.1,	0.01,	2.5,	0.03,	0,	0.00,	0.8,	0.01,	2,		0.02,	0,	0,	'Green',	0.24],
                  ['=texts!B407',	  100,	    'g',	  1,	  57,		0.57,	0.30,	0.00,	0.0,	0.00,	0.0,	0.00,	14.5,	0.15,	2.4,	0.02,	10.0,	0.10,	0,	0.00,	0.7,	0.01,	1,		0.01,	0,	0,	'Green',	0.57],
                  ['=texts!B408',	  100,	    'g',	  1,	  34,		0.34,	0.86,	0.01,	0.1,	0.00,	0.0,	0.00,	6.1,	0.06,	0.9,	0.01,	8.0,	0.08,	0,	0.00,	2.1,	0.02,	16,		0.16,	0,	0,	'Green',	0.34],
                  ['=texts!B409',	  100,	    'g',	  1,	  41,		0.41,	0.20,	0.00,	0.0,	0.00,	0.0,	0.00,	10.0,	0.10,	3.0,	0.03,	3.5,	0.04,	0,	0.00,	0.9,	0.01,	58,		0.58,	0,	0,	'Green',	0.41],
                  ['=texts!B410',	  100,	    'g',	  1,	  553,	5.53,	44.00,0.44,	9.2,	0.09,	0.0,	0.00,	30.0,	0.30,	3.0,	0.03,	5.0,	0.05,	0,	0.00,	18.0,	0.18,	640,	6.40,	0,	0,	'Red',		5.53],
                  ['=texts!B411',	  100,	    'g',	  1,	  14,		0.14,	0.20,	0.00,	0.0,	0.00,	0.0,	0.00,	3.0,	0.03,	1.6,	0.02,	1.3,	0.01,	0,	0.00,	0.7,	0.01,	80,		0.80,	0,	0,	'Green',	0.14],
                  ['=texts!B412',	  100,	    'g',	  1,	  30,		0.30,	0.70,	0.01,	0.1,	0.00,	0.0,	0.00,	4.4,	0.04,	2.5,	0.03,	1.9,	0.02,	0,	0.00,	3.3,	0.03,	3,		0.03,	0,	0,	'Green',	0.30],
                  ['=texts!B413',	  100,	    'g',	  1,	  20,		0.20,	0.40,	0.00,	0.1,	0.00,	0.0,	0.00,	1.8,	0.02,	1.0,	0.01,	1.7,	0.02,	0,	0.00,	1.8,	0.02,	3,		0.03,	0,	0,	'Green',	0.20],
                  ['=texts!B414',	  100,	    'g',	  1,	  15,		0.15,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	3.6,	0.04,	0.5,	0.01,	1.7,	0.02,	0,	0.00,	0.7,	0.01,	2,		0.02,	0,	0,	'Green',	0.15],
                  ['=texts!B415',	  100,	    'g',	  1,	  131,	1.31,	9.00,	0.09,	3.1,	0.03,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0.4,	0.00,	0,	0.00,	12.5,	0.13,	142,	1.42,	0,	0,	'Yellow',	1.31],
                  ['=texts!B416',	  1,		    'pcs',	59, 	78,		78.00,5.30,	5.30,	1.8,	1.80,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0.2,	0.20,	0,	0.00,	7.4,	7.40,	84,		84.00,0,	0,  'Yellow',	1.32],
                  ['=texts!B417',	  1,		    'pcs',	50, 	66,		66.00,9.00,	9.00,	1.6,	1.60,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0.2,	0.20,	0,	0.00,	12.6,	12.60,71,		71.00,0,	0,	'Yellow',	1.32],
                  ['=texts!B418',	  100,	    'g',	  1,	  74,		0.74,	0.30,	0.00,	0.1,	0.00,	0.0,	0.00,	19.0,	0.19,	2.9,	0.03,	16.0,	0.16,	0,	0.00,	0.8,	0.01,	1,		0.01,	0,	0,	'Green',	0.74],
                  ['=texts!B419',	  100,	    'g',	  1,	  110,	1.10,	0.60,	0.01,	0.1,	0.00,	0.0,	0.00,	16.3,	0.16,	2.1,	0.02,	1.0,	0.01,	0,	0.00,	7.9,	0.08,	17,		0.17,	0,	0,	'Yellow',	1.10],
                  ['=texts!B420',	  100,	    'g',	  1,	  67,		0.67,	0.40,	0.00,	0.1,	0.00,	0.0,	0.00,	17.0,	0.17,	0.9,	0.01,	15.0,	0.15,	0,	0.00,	0.6,	0.01,	2,		0.02,	0,	0,	'Green',	0.67],
                  ['=texts!B421',	  100,	    'g',	  1,	  36,		0.36,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	9.0,	0.09,	0.8,	0.01,	8.1,	0.08,	0,	0.00,	0.5,	0.01,	18,		0.18,	0,	0,	'Green',	0.36],
                  ['=texts!B422',	  100,	    'g',	  1,	  14,		0.14,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	3.0,	0.03,	1.2,	0.01,	2.0,	0.02,	0,	0.00,	0.9,	0.01,	10,		0.10,	0,	0,	'Green',	0.14],
                  ['=texts!B423',	  100,	    'g',	  1,	  61,		0.61,	0.50,	0.01,	0.0,	0.00,	0.0,	0.00,	15.0,	0.15,	3.0,	0.03,	9.0,	0.09,	0,	0.00,	1.1,	0.01,	3,		0.03,	0,	0,	'Green',	0.61],
                  ['=texts!B424',	  100,	    'g',	  1,	  61,		0.61,	0.30,	0.00,	0.0,	0.00,	0.0,	0.00,	14.0,	0.14,	1.8,	0.02,	3.9,	0.04,	0,	0.00,	1.5,	0.02,	20,		0.20,	0,	0,	'Green',	0.61],
                  ['=texts!B425',	  100,	    'g',	  1,	  15,		0.15,	0.20,	0.00,	0.0,	0.00,	0.0,	0.00,	2.9,	0.03,	2.1,	0.02,	1.2,	0.01,	0,	0.00,	1.4,	0.01,	0,		0.00,	0,	0,	'Green',	0.15],
                  ['=texts!B426',	  100,	    'g',	  1,	  60,		0.60,	0.40,	0.00,	0.1,	0.00,	0.0,	0.00,	15.0,	0.15,	1.8,	0.02,	14.8,	0.15,	0,	0.00,	0.8,	0.01,	2,		0.02,	0,	0,	'Green',	0.60],
                  ['=texts!B427',	  100,	    'g',	  1,	  828,	8.28,	92.00,0.92,	7.1,	0.07,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0,	0.00,	0.0,	0.00,	0,		0.00,	0,	0,	'Red',		8.28],
                  ['=texts!B428',	  100,	    'g',	  1,	  47,		0.47,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	12.0,	0.12,	2.2,	0.02,	8.5,	0.09,	0,	0.00,	0.9,	0.01,	1,		0.01,	0,	0,	'Green',	0.47],
                  ['=texts!B429',	  100,	    'g',	  1,	  431,	4.31,	29.00,0.29,	15.0,	0.15,	0.9,	0.01,	4.1,	0.04,	0.0,	0.00,	0.1,	0.00,	0,	0.00,	38.0,	0.38,	1804,18.04,	0,	0,	'Red',		4.31],
                  ['=texts!B430',	  100,	    'g',	  1,	  36,		0.36,	0.80,	0.01,	0.1,	0.00,	0.0,	0.00,	6.0,	0.06,	3.3,	0.03,	0.9,	0.01,	0,	0.00,	3.0,	0.03,	56,		0.56,	0,	0,	'Green',	0.36],
                  ['=texts!B431',	  100,	    'g',	  1,	  71,		0.71,	0.30,	0.00,	0.1,	0.00,	0.0,	0.00,	18.0,	0.18,	3.6,	0.04,	4.8,	0.05,	0,	0.00,	1.2,	0.01,	10,		0.10,	0,	0,	'Green',	0.71],
                  ['=texts!B432',	  100,	    'g',	  1,	  39,		0.39,	0.25,	0.00,	0.1,	0.00,	0.0,	0.00,	9.5,	0.10,	1.5,	0.02,	8.4,	0.08,	0,	0.00,	0.9,	0.01,	0,		0.00,	0,	0,	'Green',	0.39],
                  ['=texts!B433',	  100,	    'g',	  1,	  557,	5.57,	55.00,0.55,	5.4,	0.05,	0.0,	0.00,	8.2,	0.08,	10.3,	0.10,	7.6,	0.08,	0,	0.00,	21.0,	0.21,	1,		0.01,	0,	0,	'Red',		5.57],
                  ['=texts!B434',	  100,	    'g',	  1,	  77,		0.77,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	17.0,	0.17,	2.2,	0.02,	1.2,	0.01,	0,	0.00,	2.0,	0.02,	10,		0.10,	0,	0,	'Green',	0.77],
                  ['=texts!B435',	  100,	    'g',	  1,	  130,	1.30,	0.30,	0.00,	0.1,	0.00,	0.0,	0.00,	28.0,	0.28,	0.4,	0.00,	0.1,	0.00,	0,	0.00,	2.7,	0.03,	1,		0.01,	0,	0,	'Yellow',	1.30],
                  ['=texts!B436',	  100,	    'g',	  1,	  365,	3.65,	0.70,	0.01,	0.1,	0.00,	0.0,	0.00,	80.0,	0.80,	2.8,	0.03,	0.0,	0.00,	0,	0.00,	7.0,	0.07,	1,		0.01,	0,	0,	'Red',		3.65],
                  ['=texts!B437',	  100,	    'g',	  1,	  23,		0.23,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	3.6,	0.04,	2.4,	0.02,	0.4,	0.00,	0,	0.00,	3.0,	0.03,	70,		0.70,	0,	0,	'Green',	0.23],
                  ['=texts!B438',	  100,	    'g',	  1,	  32,		0.32,	0.20,	0.00,	0.0,	0.00,	0.0,	0.00,	7.0,	0.07,	2.6,	0.03,	2.3,	0.02,	0,	0.00,	1.8,	0.02,	5,		0.05,	0,	0,	'Green',	0.32],
                  ['=texts!B439',	  100,	    'g',	  1,	  33,		0.33,	0.30,	0.00,	0.0,	0.00,	0.0,	0.00,	7.6,	0.08,	2.0,	0.02,	4.9,	0.05,	0,	0.00,	0.7,	0.01,	1,		0.01,	0,	0,	'Green',	0.33],
                  ['=texts!B440',	  100,	    'g',	  1,	  400,	4.00,	0.00,	0.00,	0.0,	0.00,	0.0,	0.00,	100.0,1.00,	0.0,  0.00,	100.0,1.00,	0,	0.00,	0.0,	0.00,	1,	  0.01,	0,	0,	'Red',		4.00],
                  ['=texts!B441',	  100,	    'g',	  1,	  18,		0.18,	0.10,	0.00,	0.0,	0.00,	0.0,	0.00,	3.8,	0.04,	1.2,	0.01,	2.6,	0.03,	0,	0.00,	0.9,	0.01,	5,		0.05,	0,	0,	'Green',	0.18],
                  ['=texts!B442',	  1,		    'g',	  1,	  0,		0.00,	0.00,	0.00,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0.0,	0.00,	0,	0.00,	0.0,	0.00,	0,		0.00,	0,	0,	'Green',	0.00],
               ];
    getSht(SHT.ITEMS).putDataAtEnd(data);
